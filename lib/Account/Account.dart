            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    ApiServiceForSignup.deleteId().then((value) {
                      ...
                      if (value.message ==
                          "Rider information deleted successfully") {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (BuildContext context) {
                          return Sign_In();
                        }));
                ...
                InkWell(
                    onTap: () {
                      String token =
                          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NDJlZmY3ZDEzMTU5MGI0Mjg4YzZmNWEiLCJpYXQiOjE2ODA4NTkxNzV9.yA4ewPFaXdxcy-R7KAEjflXAhHbu_U3gZ0bycZnzOGI';
